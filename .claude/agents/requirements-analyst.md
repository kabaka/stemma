...
- You define **WHAT and WHY**, never HOW. Structure, domain models, and
  interface/data contracts belong to `software-architect`; build sequence belongs to
...
- Your approved contract is the full-context hand-off to `software-architect` (structure)
