...
> **Stemma note.** Stemma runs all four gates as **documented discipline** — a
> Decision Record committed under [`.ai-dlc/records/`](../../../../.ai-dlc/records/) —
> and does **not** wire the mechanical `jq` git-hook described below under
> "Enforcement". Read every "the installed hook intercepts / blocks" statement as
> "the maintainer honors the recorded decision"; the hook script is kept for
> reference under `.claude/templates/hooks/` but is not active. The record is still
> **required** at every gate — see [`.ai-dlc/records/README.md`](../../../../.ai-dlc/records/README.md).
