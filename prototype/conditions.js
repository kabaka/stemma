// Lineage condition catalog — illustrative dataset (~120 conditions).
// Fields: id, name, cat (category key), base (rough lifetime prevalence %), pattern (inheritance), syn (search synonyms)
window.LINEAGE_CONDITIONS = [
  // ---- Cardiovascular ----
  { id:'cad',    name:'Coronary heart disease', cat:'card', base:9,   pattern:'Multifactorial / polygenic', syn:['heart attack','cad','ischemic heart disease','coronary artery disease','mi'] },
  { id:'htn',    name:'Hypertension',           cat:'card', base:50,  pattern:'Multifactorial', syn:['high blood pressure','bp'] },
  { id:'chol',   name:'High cholesterol',       cat:'card', base:40,  pattern:'Multifactorial / possible FH', syn:['hyperlipidemia','dyslipidemia','ldl'] },
  { id:'stroke', name:'Stroke',                 cat:'card', base:6,   pattern:'Multifactorial', syn:['cva','cerebrovascular accident','brain attack'] },
  { id:'afib',   name:'Atrial fibrillation',    cat:'card', base:25,  pattern:'Multifactorial', syn:['irregular heartbeat','af','arrhythmia'] },
  ...
  // ---- Cancer ----
  { id:'brca',   name:'Breast cancer',          cat:'canc', base:13,  pattern:'Autosomal dominant (possible BRCA)', syn:['breast carcinoma','brca'] },
  { id:'colon',  name:'Colorectal cancer',      cat:'canc', base:4.5, pattern:'Multifactorial / possible Lynch', syn:['colon cancer','bowel cancer','rectal cancer'] },
  { id:'prostate', name:'Prostate cancer',      cat:'canc', base:12,  pattern:'Multifactorial', syn:['prostate carcinoma'] },
  { id:'lung',   name:'Lung cancer',            cat:'canc', base:6,   pattern:'Multifactorial / environmental', syn:['lung carcinoma'] },
  { id:'ovarian',name:'Ovarian cancer',         cat:'canc', base:1.3, pattern:'Autosomal dominant (BRCA)', syn:['ovary cancer'] },
  { id:'panc',   name:'Pancreatic cancer',      cat:'canc', base:1.6, pattern:'Multifactorial', syn:['pancreas cancer'] },
  { id:'melanoma', name:'Melanoma',             cat:'canc', base:2.3, pattern:'Multifactorial / CDKN2A', syn:['skin cancer'] },
  { id:'gastric',name:'Gastric cancer',         cat:'canc', base:1,   pattern:'Multifactorial / CDH1', syn:['stomach cancer'] },
  { id:'endometrial', name:'Endometrial cancer',cat:'canc', base:3,   pattern:'Possible Lynch', syn:['uterine cancer','womb cancer'] },
  ...
  { id:'bladderca', name:'Bladder cancer',      cat:'canc', base:2.4, pattern:'Multifactorial', syn:[] },
  ...
  { id:'cervical', name:'Cervical cancer',      cat:'canc', base:0.6, pattern:'HPV / environmental', syn:[] },
  ...
  { id:'testicular', name:'Testicular cancer',  cat:'canc', base:0.4, pattern:'Multifactorial', syn:[] },

  // ---- Metabolic & endocrine ----
  { id:'t2d',    name:'Type 2 diabetes',        cat:'endo', base:11,  pattern:'Multifactorial', syn:['diabetes','sugar','t2dm','adult onset diabetes'] },
  { id:'t1d',    name:'Type 1 diabetes',        cat:'endo', base:0.5, pattern:'Autoimmune / polygenic', syn:['juvenile diabetes','t1dm','insulin dependent'] },
  { id:'thy',    name:'Hypothyroidism',         cat:'endo', base:12,  pattern:'Autoimmune / polygenic', syn:['underactive thyroid','hashimoto','low thyroid'] },
  ...
  // ---- Neurological ----
  { id:'alz',    name:"Alzheimer's disease",    cat:'neuro', base:11, pattern:'Late-onset multifactorial (APOE)', syn:['dementia','memory loss'] },
  ...
  // ---- Mental health ----
  { id:'dep',    name:'Depression',             cat:'ment', base:20,  pattern:'Multifactorial', syn:['major depressive disorder','mdd','low mood'] },
  { id:'anx',    name:'Anxiety disorder',       cat:'ment', base:19,  pattern:'Multifactorial', syn:['gad','panic','anxiety'] },
  ...
  { id:'celiac', name:'Celiac disease',         cat:'auto', base:1,   pattern:'Autoimmune (HLA-DQ2/DQ8)', syn:['gluten intolerance','sprue'] },
  ...
  // ---- Respiratory ----
  { id:'asthma', name:'Asthma',                 cat:'resp', base:8,   pattern:'Multifactorial / atopy', syn:['wheezing','reactive airway'] },
  ...
  { id:'pancreatitis', name:'Chronic pancreatitis', cat:'gi', base:0.5, pattern:'Multifactorial', syn:[] },
  ...
  // ---- Musculoskeletal ----
  { id:'oa',     name:'Osteoarthritis',          cat:'musc', base:25, pattern:'Multifactorial', syn:['arthritis','joint degeneration'] },
  ...
  { id:'thalassemia', name:'Thalassemia',         cat:'blood', base:0.1, pattern:'Autosomal recessive', syn:[] },
